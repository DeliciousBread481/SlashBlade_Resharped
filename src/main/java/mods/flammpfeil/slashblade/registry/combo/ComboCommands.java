...
public class ComboCommands {
    ...
    private static final Map<EnumSet<InputCommand>, ResourceLocation> DEFAULT_STANDBY = new HashMap<>();

    public static ResourceLocation initStandByCommand(LivingEntity a) {
        return initStandByCommand(a, DEFAULT_STANDBY);
    }
    ...
    public static void initDefaultStandByCommands() {
        ...
        DEFAULT_STANDBY.put(EnumSet.of(InputCommand.ON_GROUND, InputCommand.L_CLICK),
        ...
        DEFAULT_STANDBY.put(EnumSet.of(InputCommand.ON_GROUND, InputCommand.R_CLICK),
                ComboStateRegistry.COMBO_A1.getId());
        ...
        DEFAULT_STANDBY.put(EnumSet.of(InputCommand.ON_AIR), ComboStateRegistry.AERIAL_RAVE_A1.getId());
    }
}
